...
public class Main : MonoBehaviour
{
    ...
    /// <summary>
    /// Статическая функция, возвращающая WeaponDefinition из статического приватного поля WEAP_DICT класса Main
    /// </summary>
    /// <param name="wt">Тип оружия WeaponType, для которого получаем WeaponDefinition</param>
